...
def train_model(config):
    ...
    test_mean_rel_err, test_median_rel_err, test_max_rel_err = eval_test_set(model, data_path, device)
...
results_dir = "./21cm_ray_tune_KAN_results"
...
config = {
    "batch_size": tune.qrandint(100, 1000),
    "layer1": tune.qrandint(10, 100), 
    "layer2": tune.qrandint(10, 100), 
    "layer3": tune.qrandint(10, 100), 
    "grid_size": tune.qrandint(5, 7),
    "spline_order": tune.qrandint(3, 5),
    "epochs": 400,
...
trainable_with_cpu_gpu = tune.with_resources(train_model, {"cpu": 2, "gpu": 0.03})
