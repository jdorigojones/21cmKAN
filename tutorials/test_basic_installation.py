...
print('relative rms error between "true" 21cmGEM and emulated 21cmKAN signal:', error(signal_21cmGEM, signal_21cmKAN), '%')
print('absolute rms error between "true" 21cmGEM and emulated 21cmKAN signal:', error(signal_21cmGEM, signal_21cmKAN, relative=False), 'mK')
...
print('relative rms error between "true" ARES and emulated 21cmKAN signal:', error(signal_ARES, signal_21cmKAN), '%')
print('absolute rms error between "true" ARES and emulated 21cmKAN signal:', error(signal_ARES, signal_21cmKAN, relative=False), 'mK')
