...
print('relative rms error between "true" and emulated signal:', error(signal_21cmGEM, signal_21cmKAN), '%')
print('absolute rms error between "true" and emulated signal:', error(signal_21cmGEM, signal_21cmKAN, relative=False), 'mK')
...
ax1.set_yticklabels(['50', '0','-50','-100','-150','-200','-250','-300'], fontsize=30)
...
print('relative rms error between "true" and emulated signal:', error(signal_ARES, signal_21cmKAN), '%')
print('absolute rms error between "true" and emulated signal:', error(signal_ARES, signal_21cmKAN, relative=False), 'mK')
