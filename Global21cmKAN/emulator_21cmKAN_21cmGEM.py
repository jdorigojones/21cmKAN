...
model_save_path = '/projects/jodo2960/KAN/21cmKAN/models/21cmkan_model_21cmGEM_corrmaxabs_8.pth'
...
def model(layers_hidden, name=None):
    ...
    model = KAN(layers_hidden=layers_hidden, grid_size=11, spline_order=4) #model.to(device)
    return model
...
class Emulate:
    ...
    def load_model(self, model_path=model_save_path):
        ...
        """
        self.emulator = torch.load(model_file_path, weights_only=False)
