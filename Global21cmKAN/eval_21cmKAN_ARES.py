...
class evaluate(): 
    def __init__(self, **kwargs):
        ...
        self.train_mins = np.load('/projects/jodo2960/KAN/21cmKAN/data/train_mins_ARES.npy')
        self.train_maxs = np.load('/projects/jodo2960/KAN/21cmKAN/data/train_maxs_ARES.npy')
