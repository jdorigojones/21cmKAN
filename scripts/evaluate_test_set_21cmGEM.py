...
model_file_path = "/projects/jodo2960/KAN/21cmKAN/models/21cmKAN_model_21cmGEM_default2_20.pth"
#model_file_path = "/projects/jodo2960/KAN/21cmKAN/models/21cmkan_model_21cmGEM_corrmaxabs_8.pth"
...
print('mean absolute rms error for 21cmKAN pre-trained and tested on 21cmGEM:', np.mean(abs_err), 'mK')
...
#    ax.plot(nu_list, signals_21cmGEM_emulated[i], color='r', alpha=0.1)
#    ax.plot(nu_list, signals_21cmGEM_true[i], linestyle='dashed', color='k', alpha=0.1)
#ax.set_ylim(-300,50)
#ax.set_xlim(27.85,236.74)
#plt.savefig('21cmKAN_21cmGEM_test_realizations_A100_final7_2.png', dpi = 300, bbox_inches='tight', facecolor='w')
#plt.show()
